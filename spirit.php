...
<body>
    <div id="header">
        ...
        <div class="menu" id="menu">
            <ul class="menu-items">
                ...
                <li><a href="news.php">Dịch vụ</a></li>
    ...
    <div id="hienthi">
        ...
        <div id="mota">
            ...
            $sql = "SELECT * FROM `productkitp` WHERE masp='T006'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<h3>The Spirit Of Philosophy (Hemingway)</h3>
